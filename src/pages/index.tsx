  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center  ">
        ...
        <div id="about" className="about pt-[90px] px-10">
        ...
        <div className="solucion bg-[#154492] w-full mt-3 px-10">
          <div className="titlepage">
            ...
            <div className="flex py-7">
              ...
              <a className="read_morea py-2 ml-7 bg-[#ecbb2c] px-10 text-center text-lg text-[#fff]" href="{{ route('register') }}">Registrarme<i className="fa fa-angle-right"
        ...
        <div id="contact" className="contact w-full">
            <div className="container w-full">
              ...
              <div className="row">
                  <div className="col-md-8 offset-md-2 text-center px-[150px]">
                    <form id="post_form" className="contact_form">
                        <div className="row">
                          ...
                          <div className="col-md-12 my-7">
                              <button className="send_btn text-xl bg-[#ecbb2c] text-[#fffefe] py-5 rounded-[40px] w-[217px] font-semibold uppercase">Enviar</button>
                          </div>
                        </div>
                    </form>
                  </div>
