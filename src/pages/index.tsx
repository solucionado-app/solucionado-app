  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center w-full  ">
        ...
        <div id="about" className="w-full pt-[90px] px-5 max-w-7xl">
            ...
            <div className="grid md:flex">
              <div className="">
                <div className="about_box">
                  ...
                  <a className="read_morea mt-[7px] py-2 ml-10 bg-[#ecbb2c] px-5 inline-block text-center text-lg text-[#fff]" href="{{ route('register') }}">Registrarme<i className="fa fa-angle-right"
        ...
        <div className="solucion flex justify-center bg-[#154492] w-full mt-3 px-5 ">
          <div className="max-w-7xl w-full">
            <div className="titlepage ">
              <h2 className="text-[#f0f8ff] uppercase md:text-4xl font-bold"><strong className="text-[#ecbb2c] text-[17px] font-semibold">Profesionales</strong><br />SOLUCIONADORES</h2>
              ...
              <div className="flex gap-7 py-7">
                ...
                <Link className="read_morea py-2  bg-[#ecbb2c]  px-5 lg:px-5 text-center lg:text-lg text-[#fff]" href="/registro">Registrarme<i className="fa fa-angle-right"
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="titlepage uppercase text-4xl font-bold text-center">
                  <h2><strong className="yellow text-[#ecbb2c] text-[17px] font-semibold">Testimonios</strong><br />de Nuestros Clientes</h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="contact" className="contact w-full">
          <div className="container w-full">
            <div className="row">
              <div className="col-md-12">
                <div className="titlepage uppercase text-center font-bold text-4xl  py-14">
                  <h2><strong className="yellow text-[17px] text-[#ecbb2c] font-semibold">Contactenos</strong><br />Respondemos a la brevedad</h2>
                </div>
              </div>
            </div>
