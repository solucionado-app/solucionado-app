...
import ProgressBar from '../auth/FormSolucionador/ProgressBar'

const getCategoryForm = (slug: string) => dynamic(() => import(`~/components/formularios/${slug}Form`), {
...
export default function FormAll() {
    ...
    const DynamicCategoryForm = getCategoryForm(slug)
