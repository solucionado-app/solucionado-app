...
export default function HomeSelect({ categories, isLoading }: props) {
    ...
    return (
        <>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="gap-5 max-w-md w-full flex justify-between items-end">
                    <FormField
                    ...
                    <Button className="mb-[9px]" type="submit">Buscar</Button>
                </form>
            </Form>
