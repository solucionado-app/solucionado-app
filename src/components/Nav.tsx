        ...
        <>
            <nav className=" w-full bg-[#032154] py-[9px] d_none text-white relative px-4 flex justify-between items-center ">
                ...
                <div className="flex gap-4  items-center">
                    {!user.isSignedIn && <>
                        <Link className=" lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200" href="/login">Iniciar Sesión</Link>
                        <Link className=" lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200" href="/registro">Registrarse</Link>
                    </>}
