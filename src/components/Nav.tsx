        ...
        <>
            <nav className=" relative px-4 py-4 flex justify-between items-center bg-white">
                ...
                <ul className={`hidden  absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto  lg:items-center lg:w-auto lg:space-x-6`}>
                    <li><Link className={`text-sm ${router.asPath === "/" ? "text-blue-600 font-bold" : "text-gray-400"}  hover:text-gray-500`} href="/">Home</Link></li>
                    <li className="text-gray-300">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                        </svg>
                    </li>
                    <li><a className={`text-sm ${router.asPath === "/sobre-nosotros" ? "text-blue-600 font-bold" : "text-gray-400"}`} href="/sobre-nosotros">Sobre nosotros</a></li>
                    ...
                    <li><Link className={`text-sm ${router.asPath === "/contacto" ? "text-blue-600 font-bold" : "text-gray-400"}  hover:text-gray-500`} href="/contacto">Contacto</Link></li>
                    <SignedIn>
                        <li className="text-gray-300">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
                        ...
                        <li><Link className={`text-sm ${router.asPath === "/solicitudes-de-servicio" ? "text-blue-600 font-bold" : "text-gray-400"}  hover:text-gray-500`} href="/solicitudes-de-servicio">Solicitudes de Servicio</Link></li>
                    </SignedIn>
                    <SignedIn>
                        <li className="text-gray-300">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
                        ...
                        <li><Link className={`text-sm ${router.asPath === "/completar-perfil" ? "text-blue-600 font-bold" : "text-gray-400"}  hover:text-gray-500`} href="/completar-perfil">Completar Perfil</Link></li>
                    </SignedIn>
                </ul>
            ...
            <dialog ref={popover} className="top-0 transition-2 w-0 z-50  h-screen max-w-sm ml-0 mt-0 mb-0 p-0 " >
                ...
                <nav className="fixed top-0 left-0 bottom-0 flex opacity-0 flex-col w-9/12 max-w-sm py-4 px-4 transition-all duration-500 bg-white border-r overflow-y-auto">
                    ...
                    <div>
                        <ul>
                            ...
                            <li className="mb-1">
                                <Link className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="/">Sobre Nosotros</Link>
                            </li>
                            <li className="mb-1">
                                <Link className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="/contacto">Contacto</Link>
                            </li>
                        </ul>
                    </div>
